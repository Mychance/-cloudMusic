...
<div class="header">
	<div class="header-center center">
		<h1>Lyric 音乐场</h1>
		<ul class="nav">
			<li><a href="javascript:;" class="active list find">发现音乐</a></li>
			<li><a href="javascript:;" class="list">我的音乐</a></li>
			<li><a href="javascript:;" class="list">热门专辑</a></li>
			<li><a href="javascript:;" class="list">在线好友</a></li>
		</ul>
		<div class="top-tool">
	...
	<div class="sub-list">
		<div class="center">
			<ul class="sub-nav">
				<li><a class="active sub-title" href="javascript:;">推荐</a></li>
				<li><a class="sub-title" href="javascript:;">排行榜</a></li>
				<li><a class="sub-title" href="javascript:;">歌单</a></li>
				<li><a class="sub-title" href="javascript:;">主播电台</a></li>
				<li><a class="sub-title" href="javascript:;">歌手</a></li>
				<li><a class="sub-title" href="javascript:;">新碟上架</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="login pop" style="display:none">
			<form:form method="POST" id="login_form" action="user/login" commandName="user" >
		    	<div class="title draggable" >
		    	<button type="button" class="close" >&nbspx&nbsp</button>
	    		<h3>邮箱登录</h3>
		    	</div>
		        ...
		        <div class="text">
		            <form:input  type="password" path="password" placeholder="密码"/>
		        </div>
		        <div class="tips">
		        ...
		        <div class="bottom">
		        	<a id="toReg" >没有帐号？免费注册 > </a>
		        </div>
	    	</form:form>
</div>
<div class="register pop" style="display:none">
		<form:form method="POST" id="register_form" action="user/register" commandName="user" >
			<button type="button" class="close" >&nbspx&nbsp</button>
	    	<div class="title">
	    		<h3>邮箱注册</h3>
	    	</div>
	        <div class="text text-top">
	        	用户名
	            <form:input type="text" path="username" placeholder="用户名"/>
	        </div>
            <div class="text">
            	邮箱
                <form:input type="text" path="email" placeholder="邮箱"/>
	        ...
	        <div class="text">
	        	登录密码
	            <form:input type="password" path="password" placeholder="登录密码（6-16位）"/>
	        </div>
             <div class="text">
             	确认密码
            ...
            <center>
            	<form:radiobutton path="gender" value="1" checked="true"/><label>男&nbsp&nbsp&nbsp&nbsp&nbsp </label>
            	<form:radiobutton path="gender" value="0"/><label>女 </label>
            </center>
	        <div class="tips">
	        	${register_status}
	        </div>
...
<div class="collection pop store" style="display:none">
	<div class="title draggable" >
	    	<button type="button" class="close" >&nbspx&nbsp</button>
	   		<h3>添加到歌单</h3>
	</div>
	<form id="collection_form">
	    ...
	    <div class="j-flag" >
	    	<ul musicId='' multi=false></ul>
	    </div>
	</form>
</div>
<div class="createList pop" style="display:none">
	<form id="createList_form">
	    ...
	    <div class="text text-top">
	        	歌单名：
	            <input type="text" id="listName" placeholder="歌单名"/>
	    </div>
	    <div class="tips">
	        	${status}
	    </div>
	    <div class="submit">
	    		<input type="hidden" class="musicId"/>
	    		<input type="hidden" class="multi"/>
...
<div class="fix-bottom">
    ...
    <div class="fix-play">
        ...
        <div class="play-ctrl" id="play-ctrl">
    		...
    		<span class="ml-tip">已添加至播放列表</span>
    ...
    <audio id="player" controls="false" musicId=''>
        <source src=""></source>
        <embed src="" type="" controls="false">
        <input type="hidden" class="playId">
    </audio>
</div>
